...
| Arquivo | Conteúdo |
| --- | --- |
| [reference/modes-and-layout.md](reference/modes-and-layout.md) | Os três modos (FIX/DERIVED/CAPTURED), layout curated vs evolved, como distinguir |
| [reference/trust-and-cadence.md](reference/trust-and-cadence.md) | Quando confiar numa skill evolved, cadência de observação/promoção |
