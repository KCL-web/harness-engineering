...
- Uma pasta por componente (`.tsx` + arquivo de estilo do projeto + `.test.tsx`) quando o componente
  tem estilo próprio em arquivo separado (`frontend/scss-bem`); um arquivo solto quando o estilo é só
  classe utilitária (`frontend/tailwind` — ver aquela skill).
