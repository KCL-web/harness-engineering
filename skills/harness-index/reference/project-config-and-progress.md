...
- `.gsd/CONVENTIONS.md` — convenções da stack (em projetos v2 isso vira referência às skills atômicas `frontend/*`/`backend/*` que se combinam para a stack do projeto)
