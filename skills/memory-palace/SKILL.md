...
| Arquivo | Conteúdo |
| --- | --- |
| [reference/concepts.md](reference/concepts.md) | Palace/wing/room/drawer, wings e rooms convencionadas no harness |
| [reference/cadence-and-content.md](reference/cadence-and-content.md) | Cadência (wake-up/search/sweep), o que vira drawer vs ruído, search antes de decidir |
