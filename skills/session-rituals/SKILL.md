...
- Task: "implementar auth no novo endpoint" → `mempalace_search "auth flow" --wing <projeto>` e `mempalace_search "auth flow" --wing backend`
- Task: "qual lib de form usar?" → `mempalace_search "form library" --wing frontend` e `mempalace_search "form library" --wing harness`
